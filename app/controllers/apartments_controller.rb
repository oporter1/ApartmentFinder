class ApartmentsController < ApplicationController
  ...
  # GET /apartments/new
  #tying the current user to the aparment that they are building
  def new
    @apartment = current_person.apartments.build
  end
  ...
  def create
    @apartment = current_person.apartments.build(apartment_params)
